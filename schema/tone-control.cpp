...
class StaticFilter final: public ATK::ModellerFilter<double>
{
  ...
  ATK::StaticResistor<DataType> r11{1000};
  DataType ptone{22000};
  DataType ptone_trimmer{0};
  ATK::StaticCapacitor<DataType> c5{2.2e-07};
  ATK::StaticResistorCapacitor<DataType> r8c6{220, 2.2e-07};
  ATK::StaticResistor<DataType> r9{10000};
  ATK::StaticResistor<DataType> r7{1000};

public:
  StaticFilter()
  : ModellerFilter<DataType>(4, 1)
  {
  ...
  {
    // update_steady_state
    c5.update_steady_state(1. / input_sampling_rate, dynamic_state[2], static_state[0]);
    r8c6.update_steady_state(1. / input_sampling_rate, dynamic_state[3], static_state[0]);
  ...
  void process_impl(gsl::index size) const override
  {
    for(gsl::index i = 0; i < size; ++i)
    {
      ...
      // Update state
      c5.update_state(dynamic_state[2], static_state[0]);
      r8c6.update_state(dynamic_state[3], static_state[0]);
...
bool iterate() const
{
   ...
   auto  i0_= input_state[0];
    ...
    auto eq0 = + r11.get_current(d0_, d1_) + (ptone_trimmer != 1 ? (d3_ - d0_) / ((1 - ptone_trimmer) * ptone) : 0);
    auto eq1 = dynamic_state[0] - dynamic_state[2];
    auto eq2 = + (ptone_trimmer != 0 ? (d3_ - d2_) / (ptone_trimmer * ptone) : 0) + (steady_state ? 0 : c5.get_current(d2_, s0_)) + r9.get_current(d2_, s0_) - r7.get_current(i0_, d2_);
    auto eq3 = + (ptone_trimmer != 0 ? (d2_ - d3_) / (ptone_trimmer * ptone) : 0) + (ptone_trimmer != 1 ? (d0_ - d3_) / ((1 - ptone_trimmer) * ptone) : 0) + (steady_state ? 0 : r8c6.get_current(d3_, s0_));
    eqs << eq0, eq1, eq2, eq3;
    ...
    auto jac0_0 = 0 - r11.get_gradient() + (ptone_trimmer != 1 ? -1 / ((1 - ptone_trimmer) * ptone) : 0);
    auto jac0_1 = 0 + r11.get_gradient();
    auto jac0_2 = 0;
    auto jac0_3 = 0 + (ptone_trimmer != 1 ? 1 / ((1 - ptone_trimmer) * ptone) : 0);
    auto jac1_0 = 0 + 1;
    auto jac1_1 = 0;
    auto jac1_2 = 0 + -1;
    auto jac1_3 = 0;
    auto jac2_0 = 0;
    auto jac2_1 = 0;
    auto jac2_2 = 0 + (ptone_trimmer != 0 ? -1 / (ptone_trimmer * ptone) : 0) - (steady_state ? 0 : c5.get_gradient()) - r9.get_gradient() - r7.get_gradient();
    auto jac2_3 = 0 + (ptone_trimmer != 0 ? 1 / (ptone_trimmer * ptone) : 0);
    auto jac3_0 = 0 + (ptone_trimmer != 1 ? 1 / ((1 - ptone_trimmer) * ptone) : 0);
    auto jac3_1 = 0;
    auto jac3_2 = 0 + (ptone_trimmer != 0 ? 1 / (ptone_trimmer * ptone) : 0);
    auto jac3_3 = 0 + (ptone_trimmer != 0 ? -1 / (ptone_trimmer * ptone) : 0) + (ptone_trimmer != 1 ? -1 / ((1 - ptone_trimmer) * ptone) : 0) - (steady_state ? 0 : r8c6.get_gradient());
    auto det = (-1 * jac0_1 * (1 * jac1_0 * (1 * jac2_2 * jac3_3 + -1 * jac2_3 * jac3_2) + -1 * jac1_2 * (-1 * jac2_3 * jac3_0)));
    auto invdet = 1 / det;
    auto com0_0 = 0;
    auto com1_0 = -1 * (1 * jac1_0 * (1 * jac2_2 * jac3_3 + -1 * jac2_3 * jac3_2) + -1 * jac1_2 * (-1 * jac2_3 * jac3_0));
    auto com2_0 = 0;
    auto com3_0 = -1 * 0;
    auto com0_1 = -1 * (1 * jac0_1 * (1 * jac2_2 * jac3_3 + -1 * jac2_3 * jac3_2));
    auto com1_1 = (1 * jac0_0 * (1 * jac2_2 * jac3_3 + -1 * jac2_3 * jac3_2) + 1 * jac0_3 * (-1 * jac2_2 * jac3_0));
    auto com2_1 = -1 * (-1 * jac0_1 * (-1 * jac2_3 * jac3_0));
    auto com3_1 = (-1 * jac0_1 * (-1 * jac2_2 * jac3_0));
    auto com0_2 = (1 * jac0_1 * (1 * jac1_2 * jac3_3));
    auto com1_2 = -1 * (1 * jac0_0 * (1 * jac1_2 * jac3_3) + 1 * jac0_3 * (1 * jac1_0 * jac3_2 + -1 * jac1_2 * jac3_0));
    auto com2_2 = (-1 * jac0_1 * (1 * jac1_0 * jac3_3));
    auto com3_2 = -1 * (-1 * jac0_1 * (1 * jac1_0 * jac3_2 + -1 * jac1_2 * jac3_0));
    auto com0_3 = -1 * (1 * jac0_1 * (1 * jac1_2 * jac2_3));
    auto com1_3 = (1 * jac0_0 * (1 * jac1_2 * jac2_3) + 1 * jac0_3 * (1 * jac1_0 * jac2_2));
    auto com2_3 = -1 * (-1 * jac0_1 * (1 * jac1_0 * jac2_3));
    auto com3_3 = (-1 * jac0_1 * (1 * jac1_0 * jac2_2));
    Eigen::Matrix<DataType, 4, 4> cojacobian(Eigen::Matrix<DataType, 4, 4>::Zero());

    cojacobian << com0_0, com0_1, com0_2, com0_3
      , com1_0, com1_1, com1_2, com1_3
      , com2_0, com2_1, com2_2, com2_3
